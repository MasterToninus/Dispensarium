...
\begin{landscape}
	...
	\begin{minipage}[t][]{0.30 \linewidth}
		...
		\fbox{
		  \parbox{\textwidth}{
				\emph{$X$ is closed w.r.t. $\OpA$ (subgroup)} 
...
\newpage
	\begin{minipage}[c][\textheight]{0.50 \linewidth}
	    ...
	    \mbox{}\\
		%
		Consider a set $R, A$ and two binary operation as above:
		\begin{displaymath}
		...
		\fbox{
		  \parbox{\textwidth}{
				\emph{$\OpA$ is \emph{Left distributivite} with respect to $\OpB$}
		...
		\fbox{
		  \parbox{\textwidth}{
				\emph{$\OpA$ is \emph{Right distributivite} with respect to $\OpB$}
			...
			\begin{tabular}{|l|c|} %Field
			  ...
			  \hline
			   ...
			   \hline
			    ...
			    \cellcolor{blue!25} Associativity& \cellcolor{yellow!25}  \\
			    \cellcolor{blue!25} Identity& \cellcolor{yellow!25} \\
			    \cellcolor{orange!25} Inverse& \cellcolor{yellow!25} \\
			    \cellcolor{blue!25} Commutativity& 
...
\newpage
	\begin{minipage}[c][\textheight]{0.30 \linewidth}
	    \section*{Structures over a Field (Vector Space Like) MODULE!}
	    \mbox{}\\
