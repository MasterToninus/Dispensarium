...
\begin{minipage}[t]{0.5\textwidth}
	\begin{definition}[Limit of diagram $D$]
		...
		$$\textcolor{blue}{cone \bulk} s.t. \textcolor{green}{\forall cone \bulk} \quad \exists! \textcolor{red}{\bulk} \St \TriLimit$$	
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{definition}[Co-Limit of diagram $D$]
		...
		$$\textcolor{blue}{cocone \bulk} s.t. \textcolor{green}{\forall cocone \bulk} \quad \exists! \textcolor{red}{\bulk} \St \TriLimit$$	
		\begin{tikzcd}[row sep= small]
		i \ar[dd,"f"] & & D_i \ar[rd,blue] \ar[rddd,green] \ar[dd,"D(f)"']& \\
		 & & \phantom. \ar[r,phantom,blue,"\commute"] \ar[rdd,phantom,green,"\commute"] & \textcolor{blue}{W} \ar[dd,red,"\exists!"] \\
		j & & D_j \ar[ru,blue]  \ar[rd,green]& \\
		& & & \textcolor{green}{W'}
		\end{tikzcd}	
