...
\begin{definition}[Natural pairing]\label{Def:NaturalPairing}
...
\begin{definition}[Inner product on $E$]\label{Def:BundleInnerProd}
...
\begin{definition}[Inner Pairing]\label{Def:InnerPairing}
	see (1) in advances
\end{definition}
